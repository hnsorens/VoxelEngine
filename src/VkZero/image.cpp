...
MultiImageBase::MultiImageBase(VkImage* vk_images, VkImageView* imageViews, size_t imageCount)
{
...
void MultiImageBase::changeLayout(VkCommandBuffer commandBuffer, ImageLayout newLayout,
                  uint32_t index) {
...
void MultiStagedImageBase::changeLayout(VkCommandBuffer commandBuffer, ImageLayout newLayout,
                  uint32_t index) {
  impl->changeLayout(commandBuffer, newLayout, index);
}
...
void MultiStagedImageBase::write(VkCommandBuffer commandBuffer, char *data, uint32_t index) {
