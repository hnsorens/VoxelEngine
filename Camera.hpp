...
public:
    ...
    void update(std::unique_ptr<class WindowManager>& windowManager, std::unique_ptr<class VoxelWorld>& voxelWorld, int currentFrame);
...
private:
        ...
        glm::ivec3 rayCast(std::unique_ptr<class VoxelWorld>& voxelWorld, glm::vec3 rayOrigin, glm::vec3 rayDir, bool& something_hit, float maxDistance);
