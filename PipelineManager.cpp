...
PipelineManager::PipelineManager(std::unique_ptr<VulkanContext>& vulkanContext, std::unique_ptr<Raytracer>& raytracer) 
{
    createGraphicsPipeline(vulkanContext->getDevice(), vulkanContext->getRenderPass(), raytracer);
}
...
void PipelineManager::createGraphicsPipeline(VkDevice device, VkRenderPass renderPass, std::unique_ptr<Raytracer>& raytracer) 
{
...
const VkPipeline& PipelineManager::getGraphicsPipeline() const { return graphicsPipeline; }
const VkPipelineLayout& PipelineManager::getGraphicsPipelineLayout() const { return graphicsPipelineLayout; }
const VkDescriptorSet& PipelineManager::getDescriptorSet(int i) const { return descriptorSets[i]; }