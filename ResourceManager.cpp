...
void ResourceManager::createImageView(VkDevice device, VkFormat format, VkImage& image, VkImageView& imageView)
{
...
void ResourceManager::transitionImageLayout(std::unique_ptr<CommandManager>& commandManager, std::unique_ptr<VulkanContext>& vulkanContext, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) {
...
void ResourceManager::transitionImageLayout(VkCommandBuffer commandBuffer, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) 
{
