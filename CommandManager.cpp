...
VkCommandBuffer CommandManager::beginSingleTimeCommands(std::unique_ptr<VulkanContext>& vulkanContext) {
    VkCommandBufferAllocateInfo allocInfo{};
    allocInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO;
    allocInfo.level = VK_COMMAND_BUFFER_LEVEL_PRIMARY;
    allocInfo.commandPool = commandPool;
...
void CommandManager::endSingleTimeCommands(std::unique_ptr<VulkanContext>& vulkanContext, VkCommandBuffer commandBuffer) {
