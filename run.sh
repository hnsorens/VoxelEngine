...
g++ -DGLFW_INCLUDE_VULKAN main.cpp WindowManager.cpp VulkanContext.cpp SyncManager.cpp CommandManager.cpp PipelineManager.cpp Raytracer.cpp ResourceManager.cpp -o voxels -lvulkan -lglfw -lglm